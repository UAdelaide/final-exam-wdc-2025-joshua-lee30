...
     ((SELECT user_id FROM Users WHERE username = 'carol123'), 'Daisy', 'small')
  `);
    ...
    ((SELECT dog_id FROM Dogs WHERE name = 'Bella'), '2025-06-10 09:30:00', 45, 'Beachside Ave', 'accepted')
      ((SELECT dog_id FROM Dogs WHERE name = 'Rocky' AND owner_id = (SELECT user_id FROM Users WHERE username = 'alice123')), '2025-06-11 10:00:00', 60, 'City Gardens', 'open'),
     ((SELECT dog_id FROM Dogs WHERE name = 'Brandy' AND owner_id = (SELECT user_id FROM Users WHERE username = 'joshowner')), '2025-06-12 07:30:00', 30, 'Brighton Beach', 'open'),
     ((SELECT dog_id FROM Dogs WHERE name = 'Daisy' AND owner_id = (SELECT user_id FROM Users WHERE username = 'carol123')), '2025-06-12 08:45:00', 45, 'Botanic Walk', 'completed')
  `);
        }
    } catch (err) {
